		...
		<div class="span24">
			...
			<span>第<s:property value="pageBean.currentPage"/>/<s:property value="pageBean.totalPage"/>页</span>
				<s:if test="pageBean.currentPage!=1">
					<a class="firstPage" href="${pageContext.request.contextPath }/order_findByUid.action?currentPage=1" >&nbsp;</a>
					<a class="previousPage" href="${pageContext.request.contextPath }/order_findByUid.action?currentPage=<s:property value="pageBean.currentPage-1"/>" >&nbsp;</a>
				</s:if>
